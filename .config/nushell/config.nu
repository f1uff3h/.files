...
alias g123dev = podman container run -it -v go-nu:/root/.config/nushell -v go-nv:/root/.local/share/nvim -v persist-z:/root/.local/share/zoxide -v copilot:/root/.config/github-copilot -v $'($env.HOME)/repos/.init/:/init' -v $'($env.HOME)/.ssh/:/root/.ssh:ro' -v $'($env.HOME)/.gitconfig:/root/.gitconfig:ro' -v ./:/workspace godev:1.23 nu
